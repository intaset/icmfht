...
Thank you for registering for ICMFHT 2017. If you have requested any official letters, please allow up to 5 business days to receive your documents.
...
To reserve a room with a DISCOUNTED price, please fill out the provided booking form here: www.icmfht.com/accommodation/#Hotel_Alimara_Barcelona
...
$your_subject = "Your Registration Details for ICMFHT'17";

$your_headers = "From: ICMFHT'17 <" . $my_email . ">";
...
<title>ICMFHT'17 - Registration Form Filled!</title>
...
<p class="body" style="text-align:center!important;">ICMFHT'17 is part of the <b>2<sup>nd</sup> World Congress on Momentum, Heat and Mass Transfer (MHMT'17)</b>. For more information about the congress, please visit the website here: <a href="http://mhmtcongress.com/" class="body-link">www.mhmtcongress.com</a>.</p>
        </div>
    </div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICMFHT'17!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICMFHT'17, please fill out the form below:</p>
