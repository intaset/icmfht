<?php
$my_email = "registration@icmfht.com";
$errors = array();
...
Thank you for registering for ICMFHT 2018. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us the final version of your paper and a signed copyright form via email to info@icmfht.com. You can find the copyright form here: www.icmfht.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

To reserve a room with a DISCOUNTED price, please fill out the provided booking form here: www.icmfht.com/accommodation/#0

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icmfht.com mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for ICMFHT'18";

$your_headers = "From: ICMFHT'18 <" . $my_email . ">";
...
<title>ICMFHT'18 - Registration Form Filled!</title>
...
<p class="body" style="text-align:center!important;">ICMFHT'18 is part of the <b>3<sup>rd</sup> World Congress on Momentum, Heat and Mass Transfer (MHMT'18)</b>. For more information about the congress, please visit the website here: <a href="http://mhmtcongress.com/" class="body-link">www.mhmtcongress.com</a>.</p>
        </div>
    </div>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICMFHT'18 is part of the <b>3<sup>rd</sup> World Congress on Momentum, Heat and Mass Transfer (MHMT'18)</b>.<br>For more information about the congress, please visit the website here: <a href="http://mhmtcongress.com/" class="body-link">www.mhmtcongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICMFHT 2018:</p>
      <p class="body">ICMFHT 2018 will  be held in Budapest, Hungary on April 12 - 14, 2018 at the Novotel Budapest Centrum.</p>
  ...
  <div>
      ...
      <p class="body">ICMFHT attracts a wide range of researchers in the field of multiphase flow and heat transfer. As a prominent company in the field of multiphase flow and heat transfer, we would like to offer you an exhibit at ICMFHT. Please visit <a href="../sponsor" class="body-link">Sponsors</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
    ...
    <p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@icmfht.com" class="body-link">registration@icmfht.com</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

  <p class="body">We are looking forward to seeing you at ICMFHT'18!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
    ...
    +1-613-834-9999<br>
    <a href="mailto:info@icmfht.com">info@icmfht.com</a></p>
    </div>
  </div>
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6Lcd9g0TAAAAAIFwjgsBTbXHlwoG-uzINrUXVwTO"></div></center>
  <div class="cf">
